...
icp_task = Task(
    ...
    expected_output="""In markdown format. Create an ideal customer profile document of approximately 250 words, including:
...
pains_task = Task(
    ...
    expected_output="""In markdown format. Synthesize findings into a report of approximately 250 words, including:
            - A title
