...
jtbd_task = Task(
    ...
    expected_output="""<h1>Create a Jobs to Be Done (JTBD) report based on the simulated interview with the ideal customer profile. The report should be approximately 200 words and include:</h1>
            <h2>- A title</h2>
...
pains_task = Task(
    ...
    expected_output="""<h1>Synthesize findings into a report of approximately 250 words, including:</h1>
            ...
            <p>Each section should begin with an overview followed by detailed examples. </p>
            <p>Format the document as a concise, structured report with headings, subheadings, and bullet points for easy reference and sharing among team members.</p>
