...
icp_task = Task(
    description=f"""Your task is to create a detailed 200 words ideal customer profile that will guide marketing and product development strategies for a business selling the product ."
