...
report_writer = Agent(
    role="Report Writer",
    goal="To format the text correctly. Capture customer insights, analyze data, and create comprehensive reports that inform decision-making and drive business growth.",
